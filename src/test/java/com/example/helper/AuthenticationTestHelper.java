...
public class AuthenticationTestHelper {
  ...
  public static void 管理者権限の設定() {
    ...
    Authentication authentication = new TestingAuthenticationToken(details, null, "ROLE_ADMIN");
  ...
  public static void 一般権限の設定() {
    ...
    Authentication authentication = new TestingAuthenticationToken(details, null, "ROLE_USER");
