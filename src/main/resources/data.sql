...
insert into mst_password (mst_password_id, employee_id, password, generation) values(2, '02', '$2a$10$9C7HkrU8Cuny7wcvKGTgFOcxUSeZ5Bt5wyZee3xAmJmG0PgT1nPty', '01');
insert into mst_password (mst_password_id, employee_id, password, generation) values(3, '01', '$2a$10$9C7HkrU8Cuny7wcvKGTgFOcxUSeZ5Bt5wyZee3xAmJmG0PgT1nPty', '02');
insert into mst_password (mst_password_id, employee_id, password, generation) values(4, '03', '$2a$10$9C7HkrU8Cuny7wcvKGTgFOcxUSeZ5Bt5wyZee3xAmJmG0PgT1nPty', '01');
